...
ret = rrdtool.create("test.rrd",
                     ...
                     #  Cantidad de archivos:Numero de steps: Numero de filas o de datos que se van a guardar 
...
gra= rrdtool.graph("speed.png",
                   ...
                   "LINE1:myspeed#00FF00")
#Va a guardar la diferencia del valor actual con el anterior y es lo que se grafica 